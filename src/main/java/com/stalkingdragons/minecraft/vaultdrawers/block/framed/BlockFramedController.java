...
public class BlockFramedController extends BlockController implements IFramedBlock
{
    ...
    public void setPlacedBy (@NotNull Level world, @NotNull BlockPos pos, @NotNull BlockState state, @Nullable LivingEntity entity, @NotNull ItemStack stack) {
        ...
        com.stalkingdragons.minecraft.vaultdrawers.block.tile.BlockEntityController blockEntity = WorldUtils.getBlockEntity(world, pos, com.stalkingdragons.minecraft.vaultdrawers.block.tile.BlockEntityController.class);
        if (blockEntity == null)
            return;
    ...
    public List<ItemStack> getDrops (@NotNull BlockState state, LootParams.Builder builder) {
        ...
        items.add(getMainDrop(state, (com.stalkingdragons.minecraft.vaultdrawers.block.tile.BlockEntityController)builder.getOptionalParameter(LootContextParams.BLOCK_ENTITY)));
        return items;
    }

    protected ItemStack getMainDrop (BlockState state, com.stalkingdragons.minecraft.vaultdrawers.block.tile.BlockEntityController tile) {
    ...
    public ItemStack getCloneItemStack (LevelReader level, BlockPos pos, BlockState state, boolean p_377230_, @Nullable Player player) {
        ...
        com.stalkingdragons.minecraft.vaultdrawers.block.tile.BlockEntityController tile = WorldUtils.getBlockEntity(level, pos, com.stalkingdragons.minecraft.vaultdrawers.block.tile.BlockEntityController.class);
        if (tile != null) {
            IFramedMaterials materials = tile.material();
            if (!materials.isEmpty())
    ...
    public IFramedBlockEntity getFramedBlockEntity (@NotNull Level world, @NotNull BlockPos pos) {
        return WorldUtils.getBlockEntity(world, pos, com.stalkingdragons.minecraft.vaultdrawers.block.tile.BlockEntityController.class);
    }

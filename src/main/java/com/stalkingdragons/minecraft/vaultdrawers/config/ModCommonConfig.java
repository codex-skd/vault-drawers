...
public final class ModCommonConfig extends ConfigSpec
{
    ...
    public class Drawers
    {
        ...
        public class Compacting extends ConfigSection {
            ...
            public Compacting (String name, String... comment) {
                ...
                this.enableExtraCompactingRules = commonConfig.define("enableExtraCompactingRules", true)
                ...
                this.compRules = commonConfig.defineList("compactingRules", Arrays.asList(
        ...
        public class Storage extends ConfigSection {
            ...
            public Storage (String name, String... comment) {
                ...
                storeBlacklist = commonConfig.defineList("storeDenyList", Arrays.asList("vault_drawers:creative_vending_upgrade"), null)
    ...
    public class Integration {
        ...
        public class Jade extends ConfigSection {
            public final ChameleonConfig.ConfigEntry<Boolean> enable;
            ...
            public Jade (String name, String... comment) {
                super(name, comment);
        ...
        public Integration () {
            ...
            jade = new Jade("Jade",
                "Configuration around the Jade block inspection mod.").build();

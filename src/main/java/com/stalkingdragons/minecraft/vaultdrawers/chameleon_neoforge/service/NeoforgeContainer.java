...
import com.stalkingdragons.minecraft.vaultdrawers.chameleon.inventory.ContainerContent;
import com.stalkingdragons.minecraft.vaultdrawers.chameleon.inventory.ContainerContentSerializer;
import com.stalkingdragons.minecraft.vaultdrawers.chameleon.inventory.ContentMenuProvider;
import com.stalkingdragons.minecraft.vaultdrawers.chameleon.service.ChameleonContainer;
...
{
    @Override
    public <T extends AbstractContainerMenu, C extends ContainerContent<C>> Supplier<MenuType<T>> getContainerSupplier(ChameleonContainer.ChameleonContainerFactory<T, C> factory, ContainerContentSerializer<C> serializer) {
